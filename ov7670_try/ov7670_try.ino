...
void setup(){
  ...
  setResolution();
  setColor();
 writeReg(0x11, 14); //Earlier it had the value:writeReg(0x11, 12); New version works better for me :) !!!!
...
//     }
//   if (captureRequested) {
//     //captureImg(320, 240);  // 假设这是你的图像捕获函数
//      Serial.println("CAPTURE_SUCCESS");
//     captureRequested = false;  // 重置捕获请求标志
//   }
//   else
//   {Serial.println("CAPTURE_false");}
//   }
